...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			contentepisode.Table:  contentepisode.ValidColumn,
			contentprogress.Table: contentprogress.ValidColumn,
			course.Table:          course.ValidColumn,
			journalrecord.Table:   journalrecord.ValidColumn,
			lesson.Table:          lesson.ValidColumn,
			lessonaudio.Table:     lessonaudio.ValidColumn,
			lessontechnique.Table: lessontechnique.ValidColumn,
			technique.Table:       technique.ValidColumn,
			unit.Table:            unit.ValidColumn,
			unittechnique.Table:   unittechnique.ValidColumn,
			user.Table:            user.ValidColumn,
			userprogress.Table:    userprogress.ValidColumn,
		})
	})
