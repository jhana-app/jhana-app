...
func (uq *UserQuery) FirstID(ctx context.Context) (id gqlid.UserID, err error) {
	var ids []gqlid.UserID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) gqlid.UserID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id gqlid.UserID, err error) {
	var ids []gqlid.UserID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) gqlid.UserID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []gqlid.UserID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []gqlid.UserID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
