...
import 'package:jhanas/features/theory_watch/widgets/atoms/content_description.dart';
import 'package:jhanas/features/theory_watch/widgets/atoms/content_footer.dart';
import 'package:jhanas/features/theory_watch/widgets/atoms/content_image.dart';
import 'package:jhanas/features/theory_watch/widgets/atoms/settings_menu.dart';
import 'package:jhanas/features/theory_watch/widgets/episodes_list.dart';
...
class _ContentInfoState extends State<ContentInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageLayout(
      ...
      floatingAction: widget.activeEpisodeId != null ? _resumeFab() : null,
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 22),
                    if (widget.activeEpisodeId != null)
    ...
    return ValueListenableBuilder(
      ...
      builder: (_, mediaSource, __) => mediaSource == null
          ? FloatingActionButton.extended(
              onPressed: () {
                context.pushNamed(
                  ...
                  pathParameters: {
                    ...
                    'episodeId': widget.activeEpisodeId!,
                  },
              ...
              label: const Text('Resume', style: TextStyle(fontSize: 22)),
            )
          : const SizedBox(),
    );
  }
